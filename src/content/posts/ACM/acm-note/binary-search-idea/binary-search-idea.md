...
$$
\displaystyle Result = \max \frac{\sum_{i \in S} a_i}{\sum_{i \in S} b_i}
$$
...
$$
\displaystyle \frac{\sum_{i \in S} a_i}{\sum_{i \in S} b_i} \geq x
$$
...
[题目链接](https://ac.nowcoder.com/acm/contest/133881/J)
